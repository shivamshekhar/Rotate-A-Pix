...
namespace Rotate_A_Pix
{
    ...
    /// </summary>
    public sealed partial class TimeAttack_Lv1 : Page
    {
        Image[] imgarr = new Image[16];
        int[] winarr = new int[16];
        int counter = 60;
        DispatcherTimer newTimer = new DispatcherTimer();
        public TimeAttack_Lv1()
        {
            int i;
            ...
            Lv1grid.Visibility = Visibility.Collapsed;
        }
        ...
        public async void fade()
        {
            ...
            Storyboard.SetTarget(fadeanim, Lv1grid);
            ...
            */
            ...
            Storyboard.SetTarget(appearanim, Lv1_main);
        ...
        private void Start_Click(object sender, RoutedEventArgs e)
        {
            ...
            Lv1grid.Visibility = Visibility.Visible;
        ...
        {
            Frame.Navigate(typeof(TimeAttack_Lv2),counter);
        }

        private void TryAgain_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(TimeAttack_Lv1));
        }
    }
}
