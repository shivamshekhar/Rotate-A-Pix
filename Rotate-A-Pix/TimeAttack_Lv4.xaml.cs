...
namespace Rotate_A_Pix
{
    ...
    /// </summary>
    public sealed partial class TimeAttack_Lv4 : Page
    {
        Image[] imgarr = new Image[16];
        int[] winarr = new int[16];
        int counter = 30;
        DispatcherTimer newTimer = new DispatcherTimer();
        public TimeAttack_Lv4()
        {
            int i;
            ...
            Lv4grid.Visibility = Visibility.Collapsed;
        }
        ...
        public async void fade()
        {
            ...
            Storyboard.SetTarget(fadeanim, Lv4grid);
            ...
            */
            ...
            Storyboard.SetTarget(appearanim, Lv4_main);
            Storyboard.SetTargetProperty(appearanim, "Opacity");
            appearstoryboard.Children.Add(appearanim);
            appearstoryboard.Begin();
            newTimer.Stop();
            Frame.Navigate(typeof(FinalPage), counter);
            //NextButton.Visibility = Visibility.Visible;
        }
        public void appearpic()
        {
            Image Lv4_main = new Image();
            Lv4_main.Source = new BitmapImage(new Uri("ms-appx:///Assets/7_main.png"));
            Lv4_main.Margin = new Thickness(32, 130, 0, 0);
            Lv4_main.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Left;
            Lv4_main.VerticalAlignment = Windows.UI.Xaml.VerticalAlignment.Top;
            Lv4_main.Height = 334;
            Lv4_main.Width = 339;
            Lv4_main.Opacity = 0;
            Storyboard appearstoryboard = new Storyboard();
        ...
        {
            Frame.Navigate(typeof(TimeAttack_Lv4), 0);
        }
        ...
        private void Start_Click(object sender, RoutedEventArgs e)
        {
            ...
            Lv4grid.Visibility = Visibility.Visible;
