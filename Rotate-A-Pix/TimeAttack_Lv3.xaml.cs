...
namespace Rotate_A_Pix
{
    ...
    /// </summary>
    public sealed partial class TimeAttack_Lv3 : Page
    {
        Image[] imgarr = new Image[16];
        int[] winarr = new int[16];
        int counter = 30;
        DispatcherTimer newTimer = new DispatcherTimer();
        public TimeAttack_Lv3()
        {
            int i;
            ...
            Lv3grid.Visibility = Visibility.Collapsed;
        }
        ...
        public async void fade()
        {
            ...
            Storyboard.SetTarget(fadeanim, Lv3grid);
            ...
            */
            ...
            Storyboard.SetTarget(appearanim, Lv3_main);
        ...
        {
            Image Lv3_main = new Image();
            Lv3_main.Source = new BitmapImage(new Uri("ms-appx:///Assets/7_main.png"));
            Lv3_main.Margin = new Thickness(32, 130, 0, 0);
            Lv3_main.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Left;
            Lv3_main.VerticalAlignment = Windows.UI.Xaml.VerticalAlignment.Top;
            Lv3_main.Height = 334;
            Lv3_main.Width = 339;
            Lv3_main.Opacity = 0;
            Storyboard appearstoryboard = new Storyboard();
        ...
        private void Start_Click(object sender, RoutedEventArgs e)
        {
            ...
            Lv3grid.Visibility = Visibility.Visible;
        ...
        {
            Frame.Navigate(typeof(TimeAttack_Lv4), counter);
        }

        private void TryAgain_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(TimeAttack_Lv3),0);
        }
        public void lose()
        {
            Storyboard fadestoryboard = new Storyboard();
